...
class __TwigTemplate_d09a541188dc138400ff3f5c858782b8eb22b9753282e0fd3e589432c7ba8d25 extends Template
{
    private $source;
    private $macros = [];
...
{% if documents %}
    ...
    {% for document in documents %}
        ...
        <a href=\"{{ absoluteURL }}/{{ document.filePath }}\" target=\"_blank\" class=\"flex flex-wrap justify-start items-center rounded bg-gray-100 hover:bg-blue-100 border hover:border-blue-500 text-gray-800 hover:text-blue-700 cursor-pointer font-sans my-2 p-4 \">
        {% else %}
        <a class=\"flex flex-wrap justify-start items-center rounded bg-gray-100 border text-gray-800 font-sans my-2 p-4 \">
        {% endif %}

            <div class=\"w-full sm:w-2/5 xl:w-1/3 flex mb-4 sm:mb-0 flex items-center\">
                {{ include('ui/icons.twig.html', {'icon': document.document|lower }) }}
    ...
    {% endfor %}
{% endif %}
", "ui/personalDocuments.twig.html", "C:\\xampp\\htdocs\\rabelais\\resources\\templates\\ui\\personalDocuments.twig.html");
    }
}
